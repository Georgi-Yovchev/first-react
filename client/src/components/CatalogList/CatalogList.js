            ...
            <div className={styles["listing-section"]}>
                ...
                <div className="product">
                    ...
                    <div className="text-box">
                        ...
                        <h3 className="price">$4.99</h3>
                        <p className="description">
                            A bag of delicious passionfruit!
                        </p>
